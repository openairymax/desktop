...
const MemorySystem: React.FC = () => {
  ...
  const handleClearType = async (type?: string) => {
    if (
      !confirm(
        `确定要清空${type ? MEMORY_TYPES.find((m) => m.key === type)?.label : '所有'}记忆吗？`,
      )
    )
      return;
    try {
                ...
                return (
                  <div
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.boxShadow = `0 4px 12px ${mt.color}15`;
                    }}
                    onMouseLeave={(e) => {
                  ...
                  >
                    ...
                    >
                      ...
                      <div>
                        <div style={{ fontSize: '20px', fontWeight: 700, color: mt.color }}>
                          {count}
                        </div>
                  ...
                  >
                    <div
                      style={{
                        ...
                        justifyContent: 'center',
                        margin: '0 auto 8px',
                        boxShadow: `0 4px 14px ${node.color}35`,
                      }}
                    >
                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      >
                        ...
                        <span>
                          {new Date(mem.createdAt).toLocaleTimeString('zh-CN', {
                            hour: '2-digit',
                            minute: '2-digit',
                          })}
                        </span>
              ...
              >
                ...
                <div style={{ textAlign: 'center' }}>
                  <div style={{ fontSize: '28px', fontWeight: 700 }}>
                    {contextWindow.usedPercent.toFixed(1)}%
                  </div>
            ...
            <div className="card card-elevated">
              ...
              >
                {[
                  {
                    label: '系统提示',
                    value: contextWindow.breakdown.system,
                    color: '#a855f7',
                    max: 2048,
                  },
                  {
