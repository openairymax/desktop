          ...
          <div style={{ display: 'flex', gap: '6px', justifyContent: 'center', marginTop: '36px' }}>
            {steps.map((s) => (
              <div key={s.id} style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                <div
                  style={{
                    width: step === s.id ? '28px' : step > s.id ? '28px' : '6px',
                    height: '6px',
                    borderRadius: '3px',
                    background:
                      step === s.id
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px' }}>
              {[
                ...
                >
                  ...
                  <div
                    style={{ fontSize: '9.5px', color: 'rgba(255,255,255,0.45)', marginTop: '2px' }}
                  >
                    {stat.label}
                  </div>
                </div>
              ...
              {availableLanguages.map((lang) => (
                <button
                  ...
                  style={{
                    ...
                    background:
                      language === lang.code ? 'var(--primary-light)' : 'var(--bg-tertiary)',
                    cursor: 'pointer',
                    transition: 'all var(--transition-fast)',
                    textAlign: 'center',
                  }}
                >
                  ...
                  <div
                    style={{
                      ...
                      fontSize: '15px',
                      color:
                        language === lang.code ? 'var(--primary-color)' : 'var(--text-primary)',
                      marginBottom: '3px',
                    }}
                  >
                    {lang.name}
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    background:
                      serviceMode === opt.mode ? 'var(--primary-light)' : 'var(--bg-tertiary)',
                    cursor: 'pointer',
                    transition: 'all var(--transition-fast)',
                    textAlign: 'left',
                    position: 'relative',
                ...
                >
                  <span
                    style={{
                      ...
                      padding: '2px 8px',
                      borderRadius: '4px',
                      background: serviceMode === opt.mode ? opt.tagColor : 'var(--bg-tertiary)',
                      color: serviceMode === opt.mode ? 'white' : 'var(--text-muted)',
                      fontSize: '10.5px',
                      fontWeight: 600,
                    }}
                  >
                  ...
                  <div
                    style={{
                      ...
                      fontSize: '15px',
                      color:
                        serviceMode === opt.mode ? 'var(--primary-color)' : 'var(--text-primary)',
                      marginBottom: '6px',
                    }}
                  >
                    {opt.title}
          ...
          <div style={{ animation: 'fadeIn 0.4s ease-out', textAlign: 'center' }}>
            ...
            >
              {[
                ...
                {
                  label: '服务模式',
                  value: serviceMode === 'docker' ? 'Docker Compose' : '本地开发',
                },
            ...
            >
              ...
              >
                ...
                <span>
                  <strong>提示：</strong>
                  首次使用建议从「控制中心」开始，查看三层认知循环和四层记忆系统的实时状态。
                </span>
              </div>
            </div>
          </div>
        ...
        >
          ...
          {step < 5 ? (
            ...
            >
              ...
              {!isConfiguring && <Sparkles size={17} />}
            </button>
          )}
        </div>
      </div>
