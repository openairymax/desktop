...
const Settings: React.FC = () => {
  ...
  const [endpointUrl, setEndpointUrl] = useState(
    () => localStorage.getItem('agentos-endpoint') || AGENTOS_GATEWAY_URL,
  );
  ...
  const handleExportData = () => {
    ...
    a.href = url;
    a.download = `airymax-agentos-backup-${new Date().toISOString().slice(0, 10)}.json`;
    a.click();
  ...
  return (
    <div style={{ maxWidth: '900px', margin: '0 auto' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '24px' }}>
        ...
        <div>
          <h1
            style={{ margin: 0, fontSize: '22px', fontWeight: '700', color: 'var(--text-primary)' }}
          >
            {t('settingsExtended.title')}
          </h1>
          <p style={{ margin: '2px 0 0 0', fontSize: '13px', color: 'var(--text-muted)' }}>
            {t('settingsExtended.subtitle')}
          </p>
        </div>
      </div>
      ...
      {activeTab === 'appearance' && (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} role="tabpanel" id="panel-appearance" aria-labelledby="tab-appearance">
          ...
          >
            ...
            >
              {t('settingsExtended.appearanceTitle')}
            </h3>
            <div style={{ marginBottom: '20px' }}>
              ...
              >
                {t('settingsExtended.themeMode')}
              </label>
              <div style={{ display: 'flex', gap: '8px' }}>
                {[
                  {
                    value: 'dark',
                    label: t('settingsExtended.darkTheme'),
                    desc: t('settingsExtended.darkThemeDesc'),
                  },
                  {
                    value: 'light',
            ...
            <div style={{ marginBottom: '20px' }}>
              ...
              >
                {t('settingsExtended.interfaceLanguage')}
              </label>
              <select
                value={language}
      ...
      {activeTab === 'gateway' && (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} role="tabpanel" id="panel-gateway" aria-labelledby="tab-gateway">
          ...
          >
            ...
            >
              {t('settingsExtended.gatewayTitle')}
            </h3>
            <div style={{ marginBottom: '20px' }}>
              <label
                style={{
              ...
              >
                {t('settingsExtended.gatewayAddress')}
              </label>
              <input
                type="text"
                value={endpointUrl}
            ...
            <div
              style={{
                ...
                borderRadius: '8px',
                border: '1px solid var(--info-color)33',
              }}
            >
      ...
      {activeTab === 'data' && (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} role="tabpanel" id="panel-data" aria-labelledby="tab-data">
          ...
          >
            ...
            >
              {t('settingsExtended.dataManagementTitle')}
            </h3>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              ...
              >
                <Download size={16} /> {t('settingsExtended.exportAllData')}
              </button>
              <button
              ...
              >
                <Trash2 size={16} /> {t('settingsExtended.clearAllData')}
              </button>
            </div>
            <div
              style={{
                ...
                borderRadius: '8px',
                border: '1px solid var(--warning-color)33',
              }}
            >
      ...
      >
        ...
        >
          ...
          {saved ? t('settingsExtended.saved') : t('settingsExtended.saveSettings')}
        </button>
      </div>
    </div>
  );
